...
RECORDER_INFO = [
    {
        'folder': "/home/zc/carla/lb2/leaderboard/database/ScenarioLogs",
        # 'folder': "RouteLogs/0",
        'name': 'AccidentTwoWays',
        'start_time': 10,
        'duration': 30
    }
]
...
def capture_data():
    ...
    try:
        ...
        for recorder_info in RECORDER_INFO:
            ...
            # save_agent = DataRecorder(args.host, args.port)
            ...
            while True:
                ...
                while True:
                    ...
                    # ################### ADD ###################
                    # input_data = sensor_interface.get_data(GameTime.get_frame())
                    # _ = save_agent.run_step(input_data, timestamp=None)
                    # ################### ADD ###################
