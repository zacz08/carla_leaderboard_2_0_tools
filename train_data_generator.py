...
> SENSORS: List of all the sensors that will be spawned in the simulation
...
SENSORS = [
    [
        'CamFront',
        {
            ...
            'image_size_x': cam_config['width'], 
            'image_size_y': cam_config['height'], 
            'fov': cam_config['fov'],
    ...
    #         'image_size_y': cam_config['height'], 
    #         'fov': cam_config['fov'],
    #         'x': -1.3, 'y': 0.0, 'z': 2.3, 'roll': 0.0, 'pitch': 0.0, 'yaw': -120.0
    #     },
    # ],
    # [
    #     'CamRearRight',
...
RECORDER_INFO = [
    {
        'folder': "ScenarioLogs/AccidentTwoWays",
        'start_time': 20,
        'duration': 10
    },
    # {
